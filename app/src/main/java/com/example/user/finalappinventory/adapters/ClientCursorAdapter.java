...
public class ClientCursorAdapter extends CursorAdapter {
    ...
    final ClientCursorAdapter.ItemClickListener mCallback;

    public ClientCursorAdapter(@NonNull Context context, Cursor cursor, ClientCursorAdapter.ItemClickListener listener) {
